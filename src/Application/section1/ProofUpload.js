...
const ProofUpload = () => {
  ...
  return (
    <FormSection>
      ...
      <p>
        Check which proof applies to your status, then upload your documents
        below.
      </p>
      ...
      <p>
        Proof of your address and a student ID card on its own if it shows all
        the following:
      </p>
      <ul>
        <li>your name</li>
      ...
      <details className="wmnds-details">
        ...
        <div className="wmnds-details__content">
          <p>
            If your student ID card does not show all these details, you&apos;ll
            also need to upload one of the following items:
          </p>
          <ul>
            <li>an official student finance letter</li>
            <li>an enrolment letter or email</li>
            <li>
              a letter or email from your college or university to confirm you
      ...
      <details className="wmnds-details">
        ...
        <div className="wmnds-details__content">
          <p>
            If your student ID card is unavailable, you&apos;ll need to upload
          ...
          <p>
            If you only have one of the items above, you&apos;ll also need to
      ...
      <br />
      <p className="wmnds-inset-text">
        All documents are subject to further validation and you or your college
        or university may be contacted for more information.
      </p>
      ...
      <h3>
        If you are attending an organisation supporting people not in education,
        training or employment
      </h3>
      <p>Your proof must include:</p>
      <ul>
        <li>
          letter from the organisation supporting you confirming you meet the
          income assessed requirements
        </li>
      </ul>
      <h2>Upload Documents</h2>
      <p>Use the button to upload your required proof.</p>
      <p className="wmnds-inset-text">
        Files must be in JPEG, PNG or PDF file format.
      </p>
